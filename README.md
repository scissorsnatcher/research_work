...
```
cd existing_repo
git remote add origin https://mcsgroup.gitlab.yandexcloud.net/onevision/oil-demo.git
git branch -M main
...
- [ ] [Set up project integrations](https://mcsgroup.gitlab.yandexcloud.net/onevision/oil-demo/-/settings/integrations)
